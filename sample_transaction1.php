...
$preveco_reg = isset($prevdata[0]) 
    ...
    $total = $prevquo + $preveco_nonreg + $prevqua_reg + $preveco_reg ;
     ...
     $total_qua_nonreg_3 = $sampleTransaction[1]['qua_nonreg'] + $prevquo;
        $total_eco_nonreg_3 = $sampleTransaction[1]['eco_nonreg'] + $preveco_nonreg;
        $total_qua_reg_3 = $sampleTransaction[1]['qua_reg'] + $prevqua_reg;
        $total_eco_reg_3 = $sampleTransaction[1]['eco_reg'] + $preveco_reg;
...
<?php } elseif ($i == 5) { ?>
    <?=$total_qua_nonreg_3 - $total_qua_nonreg_4.'.00'?> 
<?php } else { ?>
    <?=$regkey['qua_nonreg']?>
<?php } ?>
</td>
...
<?php } elseif ($i == 5) { ?>
    <?=$total_eco_nonreg_3 - $total_eco_nonreg_4.'.00'?>
<?php } else { ?>
    <?=$regkey['eco_nonreg']?>
<?php } ?>
</td>
...
<?php } elseif ($i == 3) { ?>
    <?=$total_qua_reg_3.'.00'?>
<?php } elseif ($i == 5) { ?>
    <?=$total_qua_reg_3 - $total_qua_reg_4.'.00'?> 
<?php } else { ?>
    <?=$regkey['qua_reg']?>
<?php } ?>
</td>
...
<?php } elseif ($i == 3) { ?>
    <?=$total_eco_reg_3.'.00'?> 
<?php } elseif ($i == 5) { ?>
    <?=$total_eco_reg_3 - $total_eco_reg_4.'.00'?> 
<?php } else { ?>
    <?=$regkey['eco_reg']?>
<?php } ?>
</td>
...
<?php } elseif ($i == 3) { ?>
    <?=$total_total_3.'.00'?>
<?php } elseif ($i == 5) { ?>
    <?=$total_total_3 - $total_total_4.'.00'?> 
<?php } else { ?>
