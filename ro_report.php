...
$sampleTransaction=$db->getCurrentSampleTransaction($db, $db->con, $user_id, $month, $year);
$revenue_transaction=$db->getCurrentRevenueTransaction($db, $db->con, $user_id, $month, $year);
$trainingTransaction=$db->getCurrentTrainingList($db, $db->con, $user_id, $month, $year);
$activityTransaction=$db->getCurrentActivityTransactionList($db, $db->con, $user_id, $month, $year);
$meetTransaction=$db->getCurrentMeetTransactionList($db, $db->con, $user_id, $month, $year);
$technicalConsultancyTransaction=$db->getCurrentTechnicalConsultancy($db, $db->con, $user_id, $month, $year);
...
<label class="control-label col-md-3"></label>
<div class="col-md-8">
<input class="form-control" type="hidden"  name="revenue_transaction_id" value="<?=$rt['revenue_transaction_id']?>"  readonly>
</div>
</div>
<div class="form-group row py-1">
<label class="control-label col-md-3">Revenue Label</label>
<div class="col-md-8">
<input class="form-control" type="text" name="revenue_label_name" value="<?=$rt['revenue_label_name']?>" readonly style="background-color: #f8f9fa;">
</div>
</div>
...
<label class="control-label col-md-3">Non-Reg Quality</label>
<div class="col-md-8">
<input class="form-control" type="number"  name="rev_qua_nonreg" value="<?=$rt['rev_qua_nonreg']?>" >
</div>
</div>
<div class="form-group row py-1">
<label class="control-label col-md-3">Non-Reg Eco</label>
<div class="col-md-8">
<input class="form-control" type="number" name="rev_eco_nonreg" value="<?=$rt['rev_eco_nonreg']?>" >
</div>
</div>
...
<label class="control-label col-md-3">Reg Quality</label>
<div class="col-md-8">
<input class="form-control" type="number" name="rev_qua_reg" value="<?=$rt['rev_qua_reg']?>">
</div>
</div>
...
<label class="control-label col-md-3">Reg Eco</label>
<div class="col-md-8">
<input class="form-control" type="number" name="rev_eco_reg" value="<?=$rt['rev_eco_reg']?>">
</div>
</div>
